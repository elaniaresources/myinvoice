...
{
    public $xmlTagName = 'InvoiceLine'; //'CreditNoteLine'; // MyInvoice System re-use back same tag name
    protected $quantityLabel = 'InvoicedQuantity'; //'CreditedQuantity'; // MyInvoice System re-use back same tag name
