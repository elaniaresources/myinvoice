...
class DocumentService extends AbstractService
{
    ...
    * @param MyInvoiceClient    $client
    ...
    {
    $baseUrl = \MyInvoice\Config\ApiUrls::getBaseUrl('documents', $prodMode);
    ...
    /**
     * This API allows taxpayer's systems to search the documents sent or received which are available on the MyInvoice System using various filters. This API will only return documents that are issued within the last 30 days.
     * 
    ...
    /**
     * This API allows taxpayer's systems to search the documents sent or received which are available on the MyInvoice System using various filters.
     * 
